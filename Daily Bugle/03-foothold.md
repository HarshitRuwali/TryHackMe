...
![[Pasted image 20210528182200.png]]

```
ound user ['811', 'Super User', 'jonah', 'jonah@tryhackme.com', '$2y$10$0veO/JSFh4389Lluc4Xya.dfy2MF.bZhz0jVMw.V.d3p12kBtZutm', '', '']

```
the hash is bcrypt 

![[Pasted image 20210528182431.png]]

cracking the hash
`hashcat -m 3200 hash /usr/share/wordlists/rockyou.txt`

![[Pasted image 20210528183007.png]]

`jonah:spiderman123`

use the creds to log in and we are in

![[Pasted image 20210528183126.png]]

and go to customise a active template and add the php rev shell 

![[Pasted image 20210528183454.png]]

![[Pasted image 20210528183706.png]]

or even better edit the error.php file 

![[Pasted image 20210528183909.png]]

save it 
![[Pasted image 20210528183923.png]]

go to http://10.10.153.244/templates/beez3/error.php
![[Pasted image 20210528184916.png]]

and we got the shell 

![[Pasted image 20210528184944.png]]
